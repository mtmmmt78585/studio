// src/lib/data.ts
import { mainUser, users, stories, videos, chats, effects, notifications } from './placeholder-data';
...
export { mainUser, users, stories, videos, chats, effects, notifications };
