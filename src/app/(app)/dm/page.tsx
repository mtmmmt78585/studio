...
import { CornerDownLeft, Search, Camera, MoreVertical, Check, Mic, Video, QrCode, MessageSquarePlus, CheckCheck, Users, Verified } from "lucide-react";
    ...
    <div className="h-full flex flex-col md:flex-row relative">
        ...
        <div className="md:w-1/3 border-r flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
             ...
             <Button className="absolute bottom-20 right-6 h-14 w-14 rounded-full shadow-lg bg-green-500 hover:bg-green-600">
